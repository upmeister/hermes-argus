...
KIT_ENTRIES = [
    ...
    {"key": "WATCHDOG_ALLOWED_USER_ID", "group": "watchdog", "check": "env",
     "required": False,
     "description": "Telegram UID владельца (доступ к командам бота)"},
    ...
    {"key": "DMS_SNITCH", "group": "infra", "check": "env", "required": False,
     "description": "ID snitch Dead Man's Snitch (runtime key, C4)"},
